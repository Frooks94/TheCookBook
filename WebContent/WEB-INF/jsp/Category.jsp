					...
					<form id="job-main-form" method="post" action="ServSearchRecipe"
						...
						<div class="controls">
							<div class="row">
								<div class="col-sm-5">
									<div class="form-group">
										<label>Ethnicity</label> <input type="text" id="ethnicity"
											name="ethnicity" placeholder="Italian, Mexican, American..."
											class="form-control" required>
									</div>
								</div>
								<div class="col-sm-5">
									<div class="form-group">
										<label>Cook Time</label> <input type="text" id="cooktime"
											name="cooktime" placeholder="30, 45, 60 in mintues"
											class="form-control" required>
									</div>
								</div>
								<div class="col-sm-2">
			...
			<div class="row">
				<div class="job-listing  ">
					...
					<div class="col-xs-12 col sm-10 col-md-10">
						<a href="#"> <c:out value="${recipe.recipeFile}"></c:out></a>
					...
					<div
						...
						<c:out value="${param.rating}"></c:out>
					</div>
