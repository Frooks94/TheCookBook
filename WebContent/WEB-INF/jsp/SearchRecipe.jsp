...
<section class="job-form-section job-form-section--image">
				...
				<form id="job-main-form" method="post" action="ServSearchRecipe"
					...
					<div class="controls">
						<div class="row">
							<div class="col-sm-5">
								<div class="form-group">
									<label for="profession">Ethnicity</label> <input type="text"
							...
							<div class="col-sm-5">
								<div class="form-group">
									<label for="location">Cook Time</label> <input type="text"
										id="flavor" name="cooktime"
										placeholder="30, 45, 60 in mintues" class="form-control">
								</div>
							</div>
							<div class="col-sm-2">
	...
	<%
		...
		LinkedList<Recipe> recipeList = rDao.searchForRecipe(request.getParameter("ethnicity"),
...
<div class="container">
		<h3 class="heading">Recipes we found</h3>
			...
			<div class="col-sm-12 col-md-6">
				<div class="row">
					<div class="col-xs-2 col-sm-2 col-md-2">
						<!-- 	<img src="img/google.png" alt="Google " class="img-responsive">-->
						<h5 class="job__title">
							<a href="#">
							<%
								out.println(recipeList.get(index).getTitle());
							%></a>
						</h5>
 ...
 %></a>
				...
				<!-- <p class="job__company">Google</p>-->
			</div>
			<div
				class="col-xs-10 col-xs-offset-2 col-sm-4 col-sm-offset-2 col-md-2 col-md-offset-0">
				<%
					out.println(recipeList.get(index).getRecipeRating());
				%>
			</div>
	...
	<div class="footer__copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<p>&copy;2016 TheAmateur Developers</p>
				</div>
